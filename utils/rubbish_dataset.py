...
class RubbishUnconditionaltBase(Dataset):
    def __init__(self,
                 txt_file,
                 data_root,
                 size=256,
...
class rubbishUnconditionalTrain(RubbishUnconditionaltBase):
    def __init__(self,txt_file="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/train_ldm.txt", data_root="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/target", **kwargs):
        super().__init__(txt_file, data_root,
                         **kwargs)


class rubbishUnconditionalValidation(RubbishUnconditionaltBase):
    def __init__(self,txt_file="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/val_ldm.txt", data_root="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/target", flip_p=0.,ag_rate=0., **kwargs):
        super().__init__(txt_file, data_root,
                         flip_p=flip_p, ag_rate=ag_rate, **kwargs)



class RubbishConditionaltBase(Dataset):
    def __init__(self,
                 txt_file,
                 data_root,
                 size=256,
...
class rubbishConditionalTrain(RubbishConditionaltBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/train_cldm.txt", data_root="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/", **kwargs)


class rubbishConditionalValidation(RubbishConditionaltBase):
    def __init__(self, flip_p=0.,ag_rate=0., **kwargs):
        super().__init__(txt_file="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/val_cldm.txt", data_root="/content/drive/MyDrive/DODA/v2/datasets/rubbish_resized2/", **kwargs)
