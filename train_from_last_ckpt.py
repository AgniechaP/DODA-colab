...
if __name__ == '__main__':
    ...
    last_checkpoint_path = '/content/drive/MyDrive/DODA/v2/logs/train_3_06/epoch=62-step=8883.ckpt' 
    seed=23
    ...
    if resume_path is not None and last_checkpoint_path is None:
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath='/content/drive/MyDrive/DODA/v2/logs/train_3_06/',
    ...
    # Train!
    trainer.fit(model, train_dataloaders = train_dataloader, val_dataloaders = val_dataloader, ckpt_path=last_checkpoint_path)
